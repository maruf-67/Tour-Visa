                            ...
                            <form method="POST" action="{{ route('admin.user.update',$user->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" name="password" class="form-control" id="staticEmail" placeholder="Enter user old password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" name="password" class="form-control" id="staticEmail" placeholder="Enter user new password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="file" name="fav_icon" id="fav_icon" class="form-control" value="{{ isset($user->image) ? $user->image : '' }}">
                                        </div>
                                        @isset($user->image)
