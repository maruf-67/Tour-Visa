...
@section('title', 'OnHold Application')
                ...
                <div class="card overflow-hidden ">
                    <div class="card-body ">
                        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 ">
                            <h6 class="card-title mb-0 text-primary">OnHold Application List</h6>
                            <div class="dropdown">
                        ...
                        <div class="col-12 mt-4">
                            <table id="OnHold-table" class="table table-striped" style="width:100%">
                                <thead>
