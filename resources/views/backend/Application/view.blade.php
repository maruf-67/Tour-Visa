                                        ...
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7">
                                                        <p class="card-text">{{ $application->sex }}</p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7">
                                                        @if(isset($application->image) && pathinfo($application->image, PATHINFO_EXTENSION) == 'pdf')
                                                            <embed src="{{ $application->image }}" type="application/pdf" width="400rem" height="300rem"/>
                                                            <div>
                                                                <a href="{{ asset($application->image) }}" download>Download PDF</a>
                                                            </div>
                                                        @else
                                                            <img src="{{ isset($application->image) ? $application->image : '' }}" alt="" wwidth="400rem" height="300rem">
                                                            <div>
                                                                <a href="{{ asset($application->image) }}" download>Download PDF</a>
                                                            </div>
                                                        @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7">
                                                        @if(isset($application->passport_bio_data) && pathinfo($application->passport_bio_data, PATHINFO_EXTENSION) == 'pdf')
                                                            <embed src="{{ $application->passport_bio_data }}" type="application/pdf" width="400rem" height="300rem"/>
                                                                <div>
                                                                    <a href="{{ asset($application->passport_bio_data) }}" download>Download PDF</a>
                                                                </div>
                                                        @else
                                                            <img src="{{ isset($application->passport_bio_data) ? $application->passport_bio_data : '' }}" alt="" width="400rem" height="300rem">
                                                            <div>
                                                                <a href="{{ asset($application->passport_bio_data) }}" download>Download PDF</a>
                                                            </div>
                                                        @endif
