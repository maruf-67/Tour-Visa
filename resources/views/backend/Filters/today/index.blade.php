...
@section('title', 'Todays Application')
                ...
                <div class="card overflow-hidden ">
                    <div class="card-body ">
                        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 ">
                            <h6 class="card-title mb-0 text-primary">Todays Application List</h6>
                            <div class="dropdown">
                                ...
                                <tbody>
                                    @foreach ($applications as $application)
                                        <tr>
                                            ...
                                            <td>{{ $application->status == 3 ? 'Approved' : '' }}</td>
